...
public class Story {
    public static void main(String[] args) {
        ...
        Hero znaika = new Hero("Знайка", inTransport, new Point(0, 0), 40);
        Hero kubik = new Hero("Кубик", inTransport, new Point(0, 0), 45);
        Hero tubik = new Hero("Тюбик", inTransport, new Point(0, 0), 42);
        Hero zvezdochkin = new Hero("Звездочкин", inTransport, new Point(0, 0), 47);
        Hero steklyashkin = new Hero("Стекляшкин", inTransport, new Point(0, 0), 39);
        Hero klepka = new Hero("Клепка", inTransport, new Point(0, 0), 35);
